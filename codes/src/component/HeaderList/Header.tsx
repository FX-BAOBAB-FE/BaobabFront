            ...
            >
                ...
                <Container maxWidth="xl" className='p-0'>
                    ...
                    <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
                        ...
                        {hambuger.map((page) => (
                            <MenuItem key={page.name} onClick={handleCloseNavMenu}>
                                <Typography sx={{ textAlign: 'center' }} component={Link} to={page.location}>{page.name}</Typography>
                            </MenuItem>
                        ))}
                        </Menu>
                    </Box>
                    ...
                    <Box sx={{display:{xs:'none',md:'flex'}}}>
                        <HeaderBtn Src={Sign} to={'/login'}>Login</HeaderBtn>
                        <HeaderBtn Src={Register} to={'/Agree'}>Register</HeaderBtn>
                    </Box>
                    {/* <Box sx={{ flexGrow: 0 }}>
