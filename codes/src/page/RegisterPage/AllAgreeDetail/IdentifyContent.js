...
< 통신사(SK텔레콤(주), (주)KT, 엘지유플러스(주)) 귀중 >
SK텔레콤(주), (주)케이티, (주)엘지유플러스(이하 ‘회사’라 함)가 휴대폰본인확인서비스(이하 ‘서비스’라 함)를 제공하기 위해 고유식별정보를 다음과 같이 제3자에게 제공 및 처리하는 것에 동의합니다.

1. 고유식별정보를 제공받는 자
- SK텔레콤(주) : SCI평가정보(주), NICE평가정보(주)
- (주)케이티 : SCI평가정보(주), 코리아크레딧뷰로(주)
- (주)엘지유플러스 : SCI평가정보(주)
2. 고유식별정보를 제공받는 자의 목적 : 연계정보(CI)와 중복가입확인정보(DI)의 생성 및 ‘회사’ 제공
3. 고유식별정보 : ‘회사’가 보유하고 있는 고객의 주민등록번호 및 외국인등록번호
4. 고유식별정보를 제공받는 자의 보유 및 이용기간 : 연계정보(CI), 중복가입확인정보(DI) 생성 후 즉시 폐기
※ 상기 고유식별정보 처리에 대한 내용에 동의하지 않으실 경우 ‘서비스’를 이용할 수 없습니다.

상기와 같이 고유식별정보 이용 및 처리에 동의합니다.


< SCI평가정보 귀중 >
SCI평가정보(주)(이하 ‘회사’라 함)가 SK텔레콤(주), (주)케이티, (주)엘지유플러스 등의 업무 대행을 통해 제공하는 휴대폰 본인확인서비스와 관련하여 이용자로부터 수집한 고유식별정보를 이용 및 처리하거나 제3자에게 제공하고자 할 때에는 '정보통신망 이용촉진 및 정보보호 등에 관한 법률' 및 ‘개인정보보호법’에 따라서 이용자로부터 동의를 받아야 합니다.
[제1조] 고유식별정보의 이용 및 처리 목적
‘회사’는 이용자의 고유식별정보를 아래의 목적으로 이용 및 처리할 수 있습니다.
1. 정보통신망법 제23조에서 정한 본인확인서비스 제공
2. 부정 이용 방지 및 수사의뢰
3. 휴대폰번호보호서비스 해제 (서비스 가입자에 한함)

[제2조] 고유식별정보의 이용 및 처리 내용
SK텔레콤(주), (주)케이티, 엘지유플러스(주) 등의 통신사 또는 통신사의 대행업무를 수행하는 사업자에 정보를 전송하여 방송통신위원회에서 고시로 지정한 휴대폰본인확인기관을 통해 본인여부를 확인하고 결과를 제공받기 위해 고유식별정보가 이용 및 처리됩니다.
- 이용 및 처리되는 고유식별정보 : 주민등록번호(내국인), 외국인등록번호(외국인)

[제3조] 고유식별정보의 보유 및 이용 기간
...
- 신용정보의 이용 및 보호에 관한 법률에 의거 정보 보존 기간 : 3년
- 계약 또는 청약철회 등에 관한 기록 : 5년
...
1. 제공자(본인확인기관): (주)케이티
2. 제공 받는자(본인확인기관): 코리아크레딧뷰로㈜, SCI평가정보㈜
3. 제공하는 항목: 주민등록번호(내국인), 외국인등록번호(국내거주외국인)
4. 제공 목적: CI(연계정보), DI(중복가입확인정보)의 생성 및 전달
5. 보유 및 이용기간: CI(연계정보), DI(중복가입확인정보) 생성 즉시 폐기
6. 위 개인정보 제공에 동의하지 않으실 경우, 서비스를 이용할 수 없습니다.
...
(주)케이티 (이하 "본인확인기관")가 (주)케이지모빌리언스 (이하 "회사")을 통해 제공하는 휴대폰 본인확인 서비스 관련하여 이용자로부터 수집한 고유식별정보를 이용하거나 타인에게 제공할 때에는 '정보통신망 이용촉진 및 정보보호 등에 관한 법률'(이하 "정보통신망법")에 따라 이용자의 동의를 얻어야 합니다.
...
4. 고유식별정보를 제공받는 자의 보유 및 이용기간: 연계정보(CI) 및 중복가입확인정보(DI) 생성 후 6개월
