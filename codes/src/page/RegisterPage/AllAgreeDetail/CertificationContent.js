...
(시행일) 이 약관은 공시한 날로부터 시행합니다.`,
    KG모빌리언스:`제1조 (목적)
본 약관은 (주)케이지모빌리언스 (이하 "회사"라 한다)이 제공하는 본인확인서비스(이하 "서비스"라 한다)에 관한 이용조건 및 절차 등 기본적인 사항을 규정함을 목적으로 합니다.
...
(시행일) 이 약관은 공시한 날로부터 시행합니다.`,
    SCI평가정보:`제 1 조 (목적)
본 약관은 SCI평가정보(주)(이하 ‘회사’라 한다)가 제공하는 본인확인서비스(이하 ‘서비스’라 한다)에 관한 이용조건 및 절차 등 기본적인 사항을 규정함을 목적으로 합니다.
