...
① 방송통신위원회 정기점검 이행조치 및 회사내부 방침에 의한 정보보유 사유로 본인확인 이력보관
...
2. 이용목적
- 이용자가 웹사이트 또는 Application에 입력한 본인확인정보의 정확성 여부 확인(본 인확인서비스 제공)
- 해당 웹사이트 또는 Application에 연계정보(CI)/중복가입확인정보(DI) 전송
- 서비스 관련 상담 및 불만 처리 등
- 이용 웹사이트/Application 정보 등에 대한 분석 및 세분화를 통한, 이용자의 서비스 이용 선호도 분석
...
4. 본인확인서비스 제공을 위한 개인정보의 취급위탁
- 수탁자 : (주)다날, (주)드림시큐리티, (주)케이지모빌리언스, (주)한국사이버결제, 한국모바일인증(주), 수미온(주), SK플래닛(주), NICE평가정보(주), SCI평가정보(주)
- 취급위탁 업무 : 본인확인정보의 정확성 여부 확인(본인확인서비스 제공), 연계정보(CI)/중복가입확인정보(DI) 생성 및 전송, 서비스 관련 상담 및 불만 처리, 휴대폰인증보호 서비스, 이용자의 서비스 이용 선호도 분석정보 제공관련 시스템 구축·광고매체 연동 및 위탁영업 등
※수탁자의 상세 개인정보 취급 위탁 내용은 각 수탁자가 정하는 절차와 방법에 따라 수탁자 홈페이지 등에 게시된 수탁자의 개인정보 취급방침 및 제3자 제공 동의 방침 등에 따릅니다.
...
4. 본인확인서비스 제공을 위한 개인정보의 취급위탁
- 수탁자 : (주)다날, (주)드림시큐리티, (주)케이지모빌리언스, (주)한국사이버결제, 한국모바일인증(주), SK플래닛(주), NICE평가정보(주), SCI평가정보(주)
- 취급위탁 업무 : 본인확인정보의 정확성 여부 확인(본인확인서비스 제공), 연계정보(CI)/중복가입확인정보(DI) 생성 및 전송, 서비스 관련 상담 및 불만 처리, 휴대폰인증보호 서비스, 이용자의 서비스 이용 선호도 분석정보 제공관련 시스템 구축 광고매체 연동 및 위탁영업 등
※수탁자의 상세 개인정보 취급 위탁 내용은 각 수탁자가 정하는 절차와 방법에 따라 수탁자 홈페이지 등에 게시된 수탁자의 개인정보 취급방침 및 제3자 제공 동의 방침 등에 따릅니다.
...
< SCI평가정보(주) 귀중 >
SCI평가정보(주)는 SK텔레콤(주)의 업무를 대행하여 휴대폰본인확인서비스를 제공함에 있어 본인의 개인정보를 수집·이용하고자 하는 경우에는 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」및 「신용정보의 이용 및 보호에 관한 법률」 에 따라 본인의 동의를 얻어야 합니다. 이에 본인은 귀사가 아래와 같이 본인의 개인정보를 수집·이용하는데 동의합니다.

[제1조] 개인정보의 수집·이용 목적
가. 서비스(회원가입, ID/PW찾기, 거래동의 등) 이용을 위한 본인확인, 식별확인 업무처리 및 정보제공
나. SK텔레콤(주)에 이용자 정보를 전송하여 본인확인 및 휴대폰 정보의 일치 여부 확인
...
제1조 [개인정보의 수집, 이용목적]
"회사"는 이용자의 개인정보를 아래의 목적으로 이용할 수 있습니다.
1. 인터넷사업자의 서비스(회원가입, ID/PW찾기 등) 이용에 필요한 이용자 본인확인 여부 및 정보 전달
(*이용자가 본인확인을 요청한 인터넷사업자에 한합니다.)
2. (주)케이티 이동통신사에 이용자 정보를 전송하여 본인확인 및 휴대폰 정보의 일치 여부 확인
3. 휴대폰 사용자 확인을 위한 SMS 인증번호 전송
4. 부정 이용 방지 및 수사의뢰
5. 이용자 본인 요청에 의한 본인확인 이력정보 제공
6. 휴대폰번호보호서비스 제공(서비스 가입자에 한함) 및 서비스 안내

제2조 [개인정보의 수집, 이용하는 개인정보의 항목]
1. 이용자가 가입한 이동통신사, 휴대폰번호, 성명, 성별, 생년월일, 내/외국인 구분
2. 연계정보(CI), 중복가입확인정보(DI)
3. 이용자가 본인확인을 요청한 서비스명 및 URL정보, 본인확인 이용일시, IP 주소

제3조 [개인정보의 취급위탁]
"회사"는 다음과 같이 개인정보의 취급을 위탁하고 있습니다.
- 수탁업체명
- 인증대행사: (주)케이지모빌리언스

- 위탁 업무 내용
: 휴대폰 본인확인서비스 업무
: 본인확인정보 및 연계정보(CI)/중복가입확인정보(DI) 전송
: 서비스 관련 업무 상담 및 불만 처리 등
(*인증대행사와 서비스 계약이 체결된 인터넷사업자에 한함)

제4조 [개인정보의 제3자 제공]
- 제공업체명 : 인터넷사업자
- 제공목적 : 인터넷사업자 이용 "고객"의 본인확인
- 제공정보 : 성명,생년월일,성별,내외국인,이동통신사,휴대폰번호,연계정보,중복가입확인정보
- 개인정보이용기간 : 인터넷사업자의 개인정보취급방침에 따름

- 제공업체명 : (주)민앤지
- 제공목적 : (주)민앤지
- 제공정보 : 휴대폰번호
- 개인정보이용기간 : 서비스 해지 및 서비스안내 종료 시 까지

제5조 [개인정보의 보유 및 이용기간]
"회사"는 이용자의 개인정보를 이용목적이 달성되거나 보유 및 보존기간이 종료하면 해당 정보를 지체없이 파기 하며 별도의 보관을 하지 않습니다. 단, 관련 법령 및 회사방침에 따라 보존하는 목적과 기간은 아래와 같습니다.
1. 소비자의 불만 또는 분쟁처리에 관한 기록 : 3년(전자상거래등에서의 소비자보호에 관한 법률)


< (주)케이지모빌리언스 귀중 >
(주)케이지모빌리언스(이하 "회사")이 (주)케이티 이동통신사로부터 위탁 받아 제공하는 휴대폰 본인확인서비스와 관련하여 이용자로부터 수집한 개인정보를 이용하고자 할 때에는 '정보통신망 이용촉진 및 정보보호 등에 관한 법률'(이하 "정보통신망법")에 따라 이용자의 동의를 얻어야 합니다.
...
< (주)케이티 귀중 >
(주)케이티(이하 ‘회사’라 함)가 제공하는 휴대폰 본인확인서비스를 이용하기 위해, 다음과 같이 ‘회사’가 본인의개인정보를 수집 및 이용하고, 개인정보의 취급을 위탁하는 것에 동의합니다.

1. 수집항목
- 이용자가 가입한 이동통신사, 휴대폰번호, 성명, 성별, 생년월일, 내/외국인 구분
- 연계정보(CI), 중복가입확인정보(DI)
- 이용자가 본인확인을 요청한 서비스명 및 URL정보, 본인확인이용일시, IP주소
...
‘회사’가 제공하는 서비스의 개인정보 취급과 관련된 사항은, 아래의 홈페이지에 기재된 개인정보취급방침에 따릅니다. (www.kt.com)

본인은 위 내용을 숙지하였으며 이에 동의합니다.


< SCI평가정보(주) 귀중 >
SCI평가정보(주)는 (주)케이티의 업무를 대행하여 휴대폰본인확인서비스를 제공함에 있어 본인의 개인정보를 수집·이용하고자 하는 경우에는 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」및 「신용정보의 이용 및 보호에 관한 법률」 에 따라 본인의 동의를 얻어야 합니다. 이에 본인은 귀사가 아래와 같이 본인의 개인정보를 수집·이용하는데 동의합니다.
...
5. 상기 개인정보 수집 및 이용과 취급위탁에 동의하지 않는 경우, 서비스를 이용할 수 없습니다.
‘회사’가 제공하는 서비스의 개인정보 취급과 관련된 사항은 아래의 ‘회사’ 홈페이지에 기재된 개인정보취급방침에 따릅니다.
- LG유플러스(주): www.lguplus.co.kr

본인은 상기 내용을 숙지하였으며 이에 동의합니다.


< (주)케이지모빌리언스 귀중 >
(주)케이지모빌리언스(이하 "회사")이 LG유플러스(주) 이동통신사로부터 위탁 받아 제공하는 휴대폰 본인확인서비스와 관련하여 이용자로부터 수집한 개인정보를 이용하고자 할 때에는 '정보통신망 이용촉진 및 정보보호 등에 관한 법률'(이하 "정보통신망법")에 따라 이용자의 동의를 얻어야 합니다.

제1조 [개인정보의 이용목적]
"회사"는 이용자의 개인정보를 아래의 목적으로 이용할 수 있습니다.
1. 인터넷사업자의 서비스(회원가입, ID/PW찾기 등) 이용에 필요한 이용자 본인확인 여부 및 정보 전달
(*이용자가 본인확인을 요청한 인터넷사업자에 한합니다.)
2. LG유플러스(주) 이동통신사에 이용자 정보를 전송하여 본인확인 및 휴대폰 정보의 일치 여부 확인
3. 휴대폰 사용자 확인을 위한 SMS 인증번호 전송
4. 부정 이용 방지 및 수사의뢰
5. 휴대폰번호보호서비스 제공(서비스 가입자에 한함) 및 서비스 안내
...
4. 이용자 가입한 이동통신사 정보
5. IP주소
6. 연계정보(CI), 중복가입확인정보(DI)

제3조 [개인정보의 취급위탁]
"회사"는 다음과 같이 LG유플러스(주)로부터 개인정보의 취급을 위탁받고 있습니다.
- 수탁업체명
- 인증대행사: (주)케이지모빌리언스
- 위탁 업무 내용
: 휴대폰 본인확인서비스
...
제4조 [개인정보의 제3자 제공]
- 제공업체명: 인터넷사업자
- 제공목적: 인터넷사업자 이용 "고객"의 본인확인 / 제공정보 : 성명,생년월일,성별,내외국인,이동통신사,휴대폰번호,연계정보,중복가입확인정보 / 개인정보이용기간 : 인터넷사업자의 개인정보취급방침에 따름

- 제공업체명: (주)민앤지
- 제공목적 : 휴대폰번호보호서비스 안내 및 해지 / 제공정보 : 휴대폰번호 / 개인정보이용기간 : 서비스 해지 및 서비스안내 종료 시 까지. (휴대폰번호보호서비스의 경우 광고성정보수신동의 한 사용자에 한하여 제공됩니다.)

제5조 [개인정보의 보유 및 이용기간]
"회사"는 이용자의 개인정보를 이용목적이 달성되면 지체 없이 파기 하며 별도의 보관을 하지 않습니다.
※ 회사가 제공하는 서비스의 개인정보 취급과 관련된 사항은, 아래의 통신사 홈페이지에 기재된 개인정보취급방침에 따릅니다. (www.uplus.co.kr)
...
< 엘지유플러스 귀중 >
(주)엘지유플러스 (이하 ‘회사’라 함)가 제공하는 휴대폰 본인확인서비스를 이용하기 위해, 다음과 같이 ‘회사’가 본인의 개인정보를 수집 및 이용하고, 개인정보의 취급을 위탁하는 것에 동의합니다.
...
5. 상기 개인정보 수집 및 이용과 취급위탁에 동의하지 않으실 경우, 서비스를 이용하실 수 없습니다.
‘회사’가 제공하는 서비스의 개인정보 취급과 관련된 사항은, 아래의 홈페이지에 기재된 개인정보취급방침에 따릅니다. (www.lguplus.co.kr)

본인은 위 내용을 숙지하였으며 이에 동의합니다.


< SCI평가정보(주) 귀중 >
SCI평가정보(주)는 (주)엘지유플러스의 업무를 대행하여 휴대폰본인확인서비스를 제공함에 있어 본인의 개인정보를 수집·이용하고자 하는 경우에는 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」및 「신용정보의 이용 및 보호에 관한 법률」 에 따라 본인의 동의를 얻어야 합니다. 이에 본인은 귀사가 아래와 같이 본인의 개인정보를 수집·이용하는데 동의합니다.

[제1조] 개인정보의 수집·이용 목적
가. 사업자의 서비스(회원가입, ID/PW찾기, 거래동의 등) 이용을 위한 본인확인, 식별확인 업무처리 및 정보제공
나. (주)엘지유플러스에 이용자 정보를 전송하여 본인확인 및 휴대폰 정보의 일치 여부 확인
다. 휴대폰 사용자 확인을 위한 SMS(또는 LMS) 인증번호 전송
라. 부정 이용 방지 및 수사의뢰
마. 이용자 본인 요청에 의한 본인확인 이력정보 제공, 민원처리, 추후 분쟁조정을 위한 기록보존, 고지사항 전달 등
바. 부가서비스 제공 및 해제(서비스 가입자에 한함)
